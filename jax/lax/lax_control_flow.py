...
def _cond_batching_rule(batched_args, batch_dims, aval_out, true_jaxpr,
  ...
  # TODO(jekbradbury): room for remaining optimization if only predicate is batched?
  true_op = batching.bdim_at_front(true_op, true_op_bd, size, force_broadcast=True)
  true_op_bd = 0
  true_consts = batching.bdim_at_front(true_consts, true_consts_bd, size,
                                       force_broadcast=True)
  true_consts_bd = 0
  false_op = batching.bdim_at_front(false_op, false_op_bd, size,
                                    force_broadcast=True)
  false_op_bd = 0
  false_consts = batching.bdim_at_front(false_consts, false_consts_bd, size,
                                       force_broadcast=True)
  false_consts_bd = 0
  ...
  pred = batching.bdim_at_front(pred, pred_bd, size, force_broadcast=True)
  pred_bd = 0
